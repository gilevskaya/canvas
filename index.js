    ...
    var Game = /** @class */ (function () {
        function Game() {
            ...
            this.resizeObserver = new ResizeObserver(function (entries) {
                ...
                _this.resize(Math.round(width), Math.round(height));
            });
            this.resizeObserver.observe(document.getElementById("container")); // this.canvas.parentNode
        ...
        Game.prototype.draw = function () {
            ...
            this.ctx.fillText("w: " + this.canvas.width, 20, 25);
            this.ctx.fillText("h: " + this.canvas.height, 20, 40);
            Background.draw();
            Bricks.draw();
            Paddle.draw();
            Ball.draw();
